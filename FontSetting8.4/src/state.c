...
int app_state_init(void) {
    ...
    app_state.font_size_status_bar = 20;
    app_state.font_size_button_label = 20;
    app_state.font_size_label = 20;
    app_state.font_size_home_contents = 30;
    ...
    strncpy(app_state.font_name_label, "NotoSansKR-Regular.ttf", sizeof(app_state.font_name_label) - 1);
    app_state.font_name_label[sizeof(app_state.font_name_label) - 1] = '\0';

    strncpy(app_state.font_name_home_contents, "NotoSansKR-Bold.ttf", sizeof(app_state.font_name_home_contents) - 1);
    app_state.font_name_home_contents[sizeof(app_state.font_name_home_contents) - 1] = '\0';
...
lv_font_t* app_state_get_font_status_bar(void) {
    return app_state.font_status_bar;
}

void app_state_set_font_status_bar(lv_font_t *font) {
    app_state.font_status_bar = font;
}

lv_font_t* app_state_get_font_label(void) {
    return app_state.font_label;
}

void app_state_set_font_label(lv_font_t *font) {
    app_state.font_label = font;
}

lv_font_t* app_state_get_font_home_contents(void) {
    return app_state.font_home_contents;
}

void app_state_set_font_home_contents(lv_font_t *font) {
    app_state.font_home_contents = font;
}
...
int app_state_get_font_size_status_bar(void) {
    return app_state.font_size_status_bar;
}

void app_state_set_font_size_status_bar(int size) {
    app_state.font_size_status_bar = size;
}
...
int app_state_get_font_size_home_contents(void) {
    return app_state.font_size_home_contents;
}

void app_state_set_font_size_home_contents(int size) {
    app_state.font_size_home_contents = size;
}
...
const char* app_state_get_font_name_label(void) {
    return app_state.font_name_label;
}

void app_state_set_font_name_label(const char *name) {
    if (name) {
        strncpy(app_state.font_name_label, name, sizeof(app_state.font_name_label) - 1);
        app_state.font_name_label[sizeof(app_state.font_name_label) - 1] = '\0';
    }
}

const char* app_state_get_font_name_home_contents(void) {
    return app_state.font_name_home_contents;
}

void app_state_set_font_name_home_contents(const char *name) {
    if (name) {
        strncpy(app_state.font_name_home_contents, name, sizeof(app_state.font_name_home_contents) - 1);
        app_state.font_name_home_contents[sizeof(app_state.font_name_home_contents) - 1] = '\0';
    }
}
