...
// Status bar slot layout (5 fixed slots with reserved edge margins)
#define STATUS_BAR_EDGE_MARGIN 15        // Reserved space from screen edges
#define STATUS_BAR_USABLE_WIDTH (SCREEN_WIDTH - (2 * STATUS_BAR_EDGE_MARGIN))  // Width between margins
#define STATUS_BAR_SLOT_WIDTH (STATUS_BAR_USABLE_WIDTH / 5)  // Width of each slot (60px for 360px screen)
#define STATUS_BAR_ICON_SIZE 40          // Size of icon button (same as ICON_SIZE_SMALL)
#define STATUS_BAR_ICON_OFFSET ((STATUS_BAR_SLOT_WIDTH - STATUS_BAR_ICON_SIZE) / 2)  // Center icon in slot
...
#define IMG_CAMERA "A:assets/images/camera_button.png"
...
#define INACTIVITY_TIMEOUT 10000  // 10 seconds of inactivity to trigger video
