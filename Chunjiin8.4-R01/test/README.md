...
```
Building tests...
gcc -I.. -o test_chunjiin test_chunjiin.c ../chunjiin.c ../input.c
gcc -I.. -o test_chunjiin_extra test_chunjiin_extra.c ../chunjiin.c ../input.c
...
5. Update `Makefile`:
   ```makefile
   test_new_feature: test_new_feature.c $(SRC_DIR)/chunjiin.c $(SRC_DIR)/input.c $(SRC_DIR)/chunjiin.h
       $(CC) $(CFLAGS) -o $@ test_new_feature.c $(SRC_DIR)/chunjiin.c $(SRC_DIR)/input.c
   ```
...
### Tests won't compile
- Verify `chunjiin.c`, `input.c`, and `chunjiin.h` exist in parent directory
