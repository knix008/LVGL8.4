...
typedef struct {
    ...
    lv_font_t *font_20;           // Font for title bar
    lv_font_t *font_button;       // Font for buttons
    lv_font_t *font_status_bar;   // Font for status bar
    lv_font_t *font_label;        // Font for labels
    lv_font_t *font_home_contents; // Font for home screen contents (welcome message)
    lv_font_t *font_24_bold;      // Bold 24pt font for welcome message (backward compatibility)
    ...
    int font_size_status_bar;     // Font size for status bar
    int font_size_button_label;   // Font size for button labels
    int font_size_label;          // Font size for labels
    int font_size_home_contents;  // Font size for home screen contents
    int font_size_bold;           // Font size for bold text (backward compatibility)
    ...
    char font_name_label[64];          // Font name for labels
    char font_name_home_contents[64];  // Font name for home screen contents
